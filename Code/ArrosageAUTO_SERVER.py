...
def submit():
    ...
    # Redirection
    params = {
        "StrDuree": request.form.get('duree'),
        "StrDateDebut": request.form.get('dateDebut'),
        "StrDateFin": request.form.get('dateFin'),
        "StrRecurrence": request.form.get('recurrence'),
        "StrZone1": "on" if request.form.get('zone1') else "off",
        "StrZone2": "on" if request.form.get('zone2') else "off",
        "StrZone3": "on" if request.form.get('zone3') else "off",
        "StrDebut1": request.form.get('heureDebut1'),
        "StrDebut2": request.form.get('heureDebut2'),
        "StrDebut3": request.form.get('heureDebut3'),
    }
