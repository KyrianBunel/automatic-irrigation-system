...
echo "Téléchargement du fichier ArrosageAUTO.py depuis GitHub..."
curl -L https://raw.githubusercontent.com/KyrianBunel/Automatic-Watering-System/main/Code/ArrosageAUTO.py -o /home/pi/Documents/ArrosageAUTO/ArrosageAUTO.py
echo "Téléchargement du fichier ArrosageAUTO_SERVER.py depuis GitHub..."
curl -L https://raw.githubusercontent.com/KyrianBunel/Automatic-Watering-System/main/Code/ArrosageAUTO_SERVER.py -o /home/pi/Documents/ArrosageAUTO/ArrosageAUTO_SERVER.py
echo "Téléchargement du fichier gestion_serie.py depuis GitHub..."
curl -L https://raw.githubusercontent.com/KyrianBunel/Automatic-Watering-System/main/Code/gestion_serie.py -o /home/pi/Documents/ArrosageAUTO/gestion_serie.py
echo "Téléchargement du fichier data.csv depuis GitHub..."
curl -L https://raw.githubusercontent.com/KyrianBunel/Automatic-Watering-System/main/Code/data.csv -o /home/pi/Documents/ArrosageAUTO/data.csv
echo "Téléchargement du fichier flows.json depuis GitHub..."
curl -L https://raw.githubusercontent.com/KyrianBunel/Automatic-Watering-System/blob/main/Code/flows.json -o /home/pi/Documents/ArrosageAUTO/flows.json
...
echo "Installation de mosquitto et des dépendances Python..."
...
echo "Création du fichier de service pour l'arrosage automatique..."
...
echo "Le Raspberry Pi va redémarrer..."
sudo reboot now
