...
curl -f https://raw.githubusercontent.com/KyrianBunel/automatic-irrigation-system/refs/heads/main/Code/start_arrosage.sh -o /home/pi/Documents/ArrosageAUTO/start_arrosage.sh || handle_error
